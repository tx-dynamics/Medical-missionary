      ...
      <View style={styles.primaryContainer}>
        ...
        <KeyboardAvoidingView behavior={"padding"}>
          <ScrollView contentContainerStyle={styles.body}>
            {/* ******************** Do you have Mistakes? Start ******************** */}
            <View style={styles.textInputContainer}>
              <Text style={styles.textInputLabel}>
                {IMLocalized(`Do you have indigestion?`)}
              </Text>
            ...
            <View style={styles.textInputContainer}>
              <Text style={styles.textInputLabel}>
                {IMLocalized(`Do you have Bloating?`)}
              </Text>
              {this._renderYesNoSelection(
                bloating,
                () => {
            ...
            <View style={styles.textInputContainer}>
              <Text style={styles.textInputLabel}>
                {IMLocalized(`How often do you have bowel evacuations?`)}
              </Text>
              {this._renderYesNoSelection(
                bowel,
                () => {
            ...
            <View style={styles.textInputContainer}>
              ...
              <CustomTextInput
                ...
                value={inputColor}
                onChangeText={(text) => {
                  this.setState({ inputColor: text, inputColorError: false });
                }}
              />
            </View>
            ...
            <View style={styles.textInputContainer}>
              <Text style={styles.textInputLabel}>
                {IMLocalized(`Do you have Diarrhea?`)}
              </Text>
              {this._renderYesNoSelection(
                diarrhea,
                () => {
            ...
            <View style={styles.textInputContainer}>
              <Text style={styles.textInputLabel}>
                {IMLocalized(`Do you have Constipation?`)}
              </Text>
              {this._renderYesNoSelection(
                constipation,
                () => {
            ...
            <View style={styles.textInputContainer}>
              <Text style={styles.textInputLabel}>
                {IMLocalized(`What color is your urine usually?`)}
              </Text>
              <CustomTextInput
                inputStyle={styles.textInput}
                errorText={IMLocalized(
                  `Please, enter your urine color usually`
                )}
                error={inputUrineUsuallyError}
                value={inputUrineUsually}
                onChangeText={(text) => {
                  this.setState({
                    inputUrineUsually: text,
                    inputUrineUsuallyError: false,
                  });
                }}
              />
            ...
            <View style={styles.textInputContainer}>
              <Text style={styles.textInputLabel}>
                {IMLocalized(`Do you wear eyeglasses?`)}
              </Text>
              {this._renderYesNoSelection(
                eyeGlasses,
                () => {
            ...
            <View style={styles.textInputContainer}>
              ...
              <CustomTextInput
                ...
                value={years}
                onChangeText={(text) => {
                  this.setState({ years: text, yearsError: false });
                }}
              />
            </View>
        ...
        {/* ******************** MODAL Start ******************** */}
        {/* <CustomModal visible={submitReport} dismiss={this._hideSubmitReport}> */}
        {/* ******************** CLOSE ICON Start ******************** */}
        {/* <TouchableOpacity
