...
export default class index extends Component {
    ...
    render = () => {
        const { inputName, inputNameError, inputDOB, inputDOBError, inputPhone, inputPhoneError, inputAge, inputAgeError,
            inputSex, inputSexError, inputHeight, inputHeightError, inputWeight, inputWeightError, inputWeightOneYearAgo, inputWeightOneYearAgoError,
            inputNationality, inputNationalityError, inputReligiousPreference, inputReligiousPreferenceError,
            inputMaritialStatus, inputMaritialStatusError, inputEmailAddress, inputEmailAddressError } = this.state;
        return (
                    ...
                    <ScrollView contentContainerStyle={styles.body}>
                        ...
                        <View style={styles.textInputContainer}>
                            ...
                            <CustomTextInput
                                ...
                                error={inputDOBError}
                                value={inputDOB}
                                onChangeText={(text) => { this.setState({ inputDOB: text, inputDOBError: false }) }}
                            />
                        </View>
                        ...
                        <View style={styles.textInputContainer}>
                            ...
                            <CustomTextInput
                                ...
                                error={inputAgeError}
                                value={inputAge}
                                onChangeText={(text) => { this.setState({ inputAge: text, inputAgeError: false }) }}
                            />
                        </View>
                        ...
                        <View style={styles.textInputContainer}>
                            ...
                            <CustomTextInput
                                ...
                                error={inputSexError}
                                value={inputSex}
                                onChangeText={(text) => { this.setState({ inputSex: text, inputSexError: false }) }}
                            />
                        </View>
                        ...
                        {/* ******************** HEIGHT Start ******************** */}
                        <View style={styles.textInputContainer}>
                            <Text style={styles.textInputLabel}>{IMLocalized(`Height:`)}</Text>
                            <CustomTextInput
                                inputStyle={styles.textInput}
                                errorText={IMLocalized(`Please, enter height`)}
                                error={inputHeightError}
                                value={inputHeight}
                                onChangeText={(text) => { this.setState({ inputHeight: text, inputHeightError: false }) }}
                            />
                        </View>
                        ...
                        {/* ******************** WEIGHT Start ******************** */}
                        <View style={styles.textInputContainer}>
                            <Text style={styles.textInputLabel}>{IMLocalized(`Weight:`)}</Text>
                            <CustomTextInput
                                inputStyle={styles.textInput}
                                errorText={IMLocalized(`Please, enter weight`)}
                                error={inputWeightError}
                                value={inputWeight}
                                onChangeText={(text) => { this.setState({ inputWeight: text, inputWeightError: false }) }}
                            />
                        </View>
                        ...
                        <View style={styles.textInputContainer}>
                            <Text style={styles.textInputLabel}>{IMLocalized(`Weight one year ago:`)}</Text>
                            <CustomTextInput
                                inputStyle={styles.textInput}
                                errorText={IMLocalized(`Please, enter weight one year ago`)}
                                error={inputWeightOneYearAgoError}
                                value={inputWeightOneYearAgo}
                                onChangeText={(text) => { this.setState({ inputWeightOneYearAgo: text, inputWeightOneYearAgoError: false }) }}
                            />
                        </View>
                        ...
                        {/* ******************** NATIONALITY Start ******************** */}
                        <View style={styles.textInputContainer}>
                            <Text style={styles.textInputLabel}>{IMLocalized(`Nationality:`)}</Text>
                            <CustomTextInput
                                inputStyle={styles.textInput}
                                errorText={IMLocalized(`Please, enter nationality`)}
                                error={inputNationalityError}
                                value={inputNationality}
                                onChangeText={(text) => { this.setState({ inputNationality: text, inputNationalityError: false }) }}
                            />
                        </View>
                        ...
                        <View style={styles.textInputContainer}>
                            <Text style={styles.textInputLabel}>{IMLocalized(`Religious Preference:`)}</Text>
                            <CustomTextInput
                                inputStyle={styles.textInput}
                                errorText={IMLocalized(`Please, enter religious preference`)}
                                error={inputReligiousPreferenceError}
                                value={inputReligiousPreference}
                                onChangeText={(text) => { this.setState({ inputReligiousPreference: text, inputReligiousPreferenceError: false }) }}
                            />
                        </View>
                        ...
                        <View style={styles.textInputContainer}>
                            <Text style={styles.textInputLabel}>{IMLocalized(`Maritial Status:`)}</Text>
                            <CustomTextInput
                                inputStyle={styles.textInput}
                                errorText={IMLocalized(`Please, enter maritial status`)}
                                error={inputMaritialStatusError}
                                value={inputMaritialStatus}
                                onChangeText={(text) => { this.setState({ inputMaritialStatus: text, inputMaritialStatusError: false }) }}
                            />
                        </View>
                        ...
                        {/* ******************** EMAL ADDRESS Start ******************** */}
                        <View style={styles.textInputContainer}>
                            <Text style={styles.textInputLabel}>{IMLocalized(`Email Address:`)}</Text>
                            <CustomTextInput
                                inputStyle={styles.textInput}
                                errorText={IMLocalized(`Please, enter email address`)}
                                error={inputEmailAddressError}
                                value={inputEmailAddress}
                                onChangeText={(text) => { this.setState({ inputEmailAddress: text, inputEmailAddressError: false }) }}
                            />
                        </View>
