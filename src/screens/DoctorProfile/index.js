...
import {
  randomBooks,
  randomProfilePictues,
  randomThumnail,
} from "../../constants/LocalAssets";
...
export default class index extends Component {
      ...
      <View style={styles.primaryContainer}>
        ...
        <ScrollView>
          ...
          <View style={styles.testimonialVideoPrimaryContainer}>
            ...
            <FlatList
              ...
              contentContainerStyle={
                styles.testimonialVideoDataContentContainer
              }
              data={videoData}
          ...
          <View style={saleStyles.primaryContainer}>
            <Text style={saleStyles.heading}>{IMLocalized(`Sale Items`)}</Text>
  ...
  _renderSaleItems = ({ item, index }) => {
    return (
      <TouchableOpacity
        style={saleItemStyles.primaryContainer}
        onPress={() => {
          this.onSaleItemPress(item, index);
        }}
      >
        <FastImage
          source={item.image}
