...
export default class index extends Component {
    ...
    render = () => {
        const { inputName, inputNameError, inputUserName, inputUserNameError, inputEmail, inputEmailError } = this.state;
        return (
            <View style={styles.primaryContainer}>
                ...
                <AppHeader
                    ...
                    title={GV.isDoctor ? IMLocalized(`Client Profile`) : IMLocalized(`Profile`)}
                />
                {/* ******************** HEADER End ******************** */}
                ...
                {GV.isDoctor &&
                    <>
                        ...
                        // onPress={() => { this.props.navigation.navigate(ROUTES.ConsultationForm) }}
                        />
